            ...
            <div style={{ borderTop: '1px solid #2A2A3A', paddingTop: 16, marginBottom: 16 }}>
              ...
              {selectedLead.linkedin_url && (
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  ...
                  <a href={selectedLead.linkedin_url} target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#6C63FF', textDecoration: 'none', maxWidth: 260, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>View profile →</a>
                </div>
              )}
            </div>
