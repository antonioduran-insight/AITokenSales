...
export async function PATCH(
  ...
  const allowed = ['name', 'slug', 'plan', 'max_seats', 'max_leads_per_month', 'billing_day', 'custom_price', 'vendor', 'is_active', 'internal_notes', 'logo_url', 'default_language', 'apify_token', 'anthropic_key']
